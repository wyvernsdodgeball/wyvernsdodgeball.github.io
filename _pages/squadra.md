...
<section id="top" class="page-hero page-hero--with-photo" style="--hero-photo: url('{{ site.baseurl }}/assets/images/wyverns-dodgeball-roma-hero.webp')">
  <div class="container">
    ...
    <div class="about-grid" data-reveal>
      ...
      <div class="about-visual">
        <picture>
          ...
          <img src="{{ site.baseurl }}/assets/images/logo.png" alt="Wyverns Dodgeball Roma" class="about-logo">
        </picture>
...
<section id="valori" class="section-join-intro">
  <div class="container">
    <div class="section-header" data-reveal>
      <span class="section-tag">In campo</span>
      <h2>COME<br>GIOCHIAMO</h2>
      <div class="divider"></div>
      <p>Quattro cose che troverai da noi dal primo allenamento.</p>
    </div>
    <div class="join-highlight-row" data-reveal>
      <div class="join-highlight-card">
        <span class="join-highlight-icon">🎽</span>
        <strong>Si parte dalle basi</strong>
        <p>Regole, lancio, schivata, presa: te le insegniamo noi</p>
      </div>
      <div class="join-highlight-card join-highlight-card--accent">
        <span class="join-highlight-icon">🐲</span>
        <strong>Un gruppo, non una selezione</strong>
        <p>Chi arriva da solo dopo tre sere conosce tutti</p>
      </div>
      <div class="join-highlight-card">
        <span class="join-highlight-icon">🏆</span>
        <strong>Chi vuole compete</strong>
        <p>Campionato e tornei FIGeST per chi ha voglia di gara</p>
      </div>
      <div class="join-highlight-card">
        <span class="join-highlight-icon">🧢</span>
        <strong>Attrezzatura inclusa</strong>
        <p>Le palle le portiamo noi, tu porta le scarpe</p>
      </div>
    </div>
  </div>
</section>
